                ...
                <div class="comments__wrapper">
                    ...
                    <form class="comments__new">
                        <div class="comments__comment-area">
                            ...
                            <textarea type="text" name="comment" placeholder="That was easily the most spectacualr BMX moment ever." maxlength="120" size="30" rows="4" width="48" height="48" className="comments__comment-input"></textarea>
                        </div>
                        <input type="submit" value="COMMENT" class="comments__button" disabled></input>
                    </form>
                </div>
                ...
                {this.state.users.map(commentObj => {
                    ...
                    <div className="comments__past">
                        ...
                        <div className="comments__info">
                            ...
                            <div className="comments__date">{timeSince(commentObj.date)}</div>
